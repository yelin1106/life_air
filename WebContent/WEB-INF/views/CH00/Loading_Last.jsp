...
<style>
	* {margin: 0; padding: 0;}
	...
	@media all and (min-width: 360px) and (max-width: 768px) { /*모바일 */
		...
		#passport{width:199px; height:248px; position: relative; top:111px; left:90px;}
	
		#footplane{width: 52px; height: 52px; position: relative; top:300px; left:-50px; padding-bottom: 66px; }
	}
	
	@media all and (min-width: 768px) { /*태블릿 */
		#main{width:768px; height: 1024px;}
		
		#boardingdiv{width: 228px; height: 46px; border-radius: 23px; top:158px; left: 270px;}
		#boarding{font-size: 33px;}
		
		#boardingpassdiv{top:200px;}
		#boardingpass{font-size: 40px; line-height: 1.43; letter-spacing: -1.4px;}
		
		#passport{width:284px; height: 354px; position: relative; top:208px; left:257px;}
	
		#footplane{width: 74px; height: 75px; position: relative; top:500px; left:60px; padding-bottom:149px; }
	}
</style>
</head>
...
<body>
	<div id = "main">
		<div id = "boardingdiv">
			<label id = "boarding">Boarding</label>
		</div>
		
		<div id = "boardingpassdiv">
			<label id = "boardingpass">탑승수속을<br>시작합니다</label>
		</div>
		
		<img src = "image/환영합니다.svg" id = "passport">
		
		<img src = "image/plane.svg" id = "footplane" onClick="location.href = 'CH01.do'">
	</div>
</body>
</html>