...
<body>
	<div id = "main">
		...
		<div id ="contentdiv"><label id = "content">보물 (1) 의 상세정보</label></div>
		...
		<div id  = "selectbox">
			<select id = "selectlabel">
				...
				<option value = "dog">다이어리</option>
				<option value = "dog">돈</option>
				<option value = "dog">롤링페이퍼</option>
				<option value = "dog">마스크</option>
				<option value = "dog">만화책</option>
				<option value = "dog">반려기구</option>
				<option value = "dog">반지</option>
				<option value = "dog">사진첩</option>
				<option value = "dog">소설책</option>
				<option value = "dog">소울푸드</option>
				<option value = "dog">술</option>
				<option value = "dog">시집</option>
				<option value = "dog">아이패드</option>
				<option value = "dog">안경</option>
				<option value = "dog">애착인형</option>
				<option value = "dog">앨범</option>
				<option value = "dog">에어팟</option>
				<option value = "dog">연필</option>
				<option value = "dog">옷</option>
				<option value = "dog">육아일기</option>
				<option value = "dog">이불</option>
				<option value = "dog">집</option>
				<option value = "dog">차</option>
				<option value = "dog">책</option>
				<option value = "dog">친필싸인집</option>
				<option value = "dog">침대</option>
				<option value = "dog">커피</option>
				<option value = "dog">편지</option>
				<option value = "dog">피규어</option>
				<option value = "dog">피아노</option>
				<option value = "dog">필름카메라</option>
				<option value = "dog">핸드폰</option>
				<option value = "dog">향수</option>
				<option value = "dog">usb</option>
			</select>
		</div>
