...
<body>
	<div id = "main">
		<img src = "image/뒤로가기_네덜란드.svg" id = "backpage" onClick="location.href = 'ticket_네덜란드.html'">
		
		<img src = "image/뽐내기_네덜란드.svg" id = "passport">
		<div id = "passengerdiv"><label id = "passenger">청승넨/여성</label></div>
		<div id = "familynamediv"><label id = "familyname">청승넨의 가족</label></div>
		
		<img src = "image/저장_네덜란드.svg" id = "capture">
	</div>
</body>
</html>