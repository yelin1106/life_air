...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #fd3a36; position: relative; display: table; text-align: center;}
...
<body>
	<div id = "main">
		...
		<img src = "image/여권_멕시코.svg" id = "passport">
		
		<img src = "image/하단_멕시코.svg" id = "footplane" onClick="location.href = 'ticket_멕시코.html'">
	</div>
</body>
</html>