...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #6932a9; position: relative; display: table; text-align: center;}
	...
	#boardingpassdiv{background-color: #6932a9; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #ffffff; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #6932a9;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #a37ad2; position: relative;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . . 하나 둘 셋, 찰칵! . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">사진 한 컷 찍을 수 있는 미국의 단독주택</font>에<br>
				도착했고, 번개와 함께 치는 천둥이<br>
				마치 오케스트라의 연주같아요.<br><br>
				미국의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">어디서든 반짝반짝 빛이 나고 누구에게나<br>
				사랑받는 소중한 사람</font>일 것 같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">사진 한 컷 찍을 수 있는 미국 단독주택</label></div>
				...
				<img src = "image/점선_미국.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_미국.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_미국.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_미국.svg" id = "passimg">
			</div>
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_미국.html'">
			</div>
