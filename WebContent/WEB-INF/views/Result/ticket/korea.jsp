...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #ff7f00; position: relative; display: table; text-align: center;}
	...
	#boardingpassdiv{background-color: #ff7f00; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #ffffff; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #ff7f00;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #ffab58; position: relative;}
	...
	@media all and (min-width: 360px) and (max-width: 768px) { /*모바일 */
		...
		#stardiv{width:320px; height: 1060px; border-radius: 15px; top:46px; }
		...
		#starimg{width: 92px; height: 112px; top:8px;}
		#snamediv{top:19px;}
	...
	@media all and (min-width: 768px) { /*태블릿 */
		...
		#stardiv{width:456px; height: 1463px; border-radius: 15px; top:46px;}
		...
		#starimg{width: 132px; height: 161px; top:30px;}
		#snamediv{top:35px;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . . 손틈새로 비추는 햇빛 . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">안개 사이로 햇빛이 쪼개지는 한옥</font><br>
				도착한 당신은 피부에 닿는 햇빛 조각들을<br>
				보며  마음 한 구석이 평온해져요.<br><br>
				한국의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">보이지는 않지만 서로를 항상<br>
				챙겨주는 관계</font>일 것 같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">안개 사이로 햇빛이 쪼개지는 한국 한옥</label></div>
				...
				<img src = "image/점선_대한민국.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_대한민국.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_대한민국.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_대한민국.svg" id = "passimg">
			</div>
			
			<div id = "stardiv">
				<div id = "startitlediv"><label id = "startitle">당신의 수호별</label></div>
				<div id = "starnamediv"><label id = "starname">불꽃 같은 아름다움이<br>있는 별, 바너드</label></div>
				<img src = "image/별자리_바너드.svg" id = "starimg">
				<div id = "snamediv"><label id = "sname">Barnard’s Star</label></div>
				<div id = "starcontentdiv"><label id = "starcontent">
					여행의 시작에 선 당신을 위해 작은 선물을 준비했어요.  불꽃같은 아름다움이 있는 별, 바너드에서 온 당신. <font style = "font-weight: bold">뜨거운 열정과 추진력을 가진 당신</font>은 놀라운 운동 속도를 가진 별 바너드와 닮았어요.<br><br>
					어떤 일이든 야무지고 꼼꼼하게 처리하는 당신은 뭇사람들의 선망을 받는 멋진 사람이군요. 그런데 혹시 잘 해내야 한다는 강박에 스스로를 지나치게 괴롭히고 있지는 않나요?<br><br>
					그런 당신을 보며 당신의 동반자는 든든함과 염려를 함께 느껴요. 지나친 몰두는 번아웃을 불러올 수도 있으니까요. 가끔은 멈춰 서서 숨을 고르며 창밖을 바라보는 건 어떨까요?<br><br>
					이 계절의 풍경이 당신에게 말을 걸어올 거예요.<br><br>
					당신에게 이 별을 드릴게요.<br><br>
					바너드의 빛과 함께 앞으로의 여정이 평화롭기를 기원합니다.
					</label>
				</div>
			</div>
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_대한민국.html'">
			</div>
