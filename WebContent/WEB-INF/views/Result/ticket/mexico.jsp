...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #fc3935; position: relative; display: table; text-align: center;}
	...
	#boardingpassdiv{background-color: #fc3935; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #ffffff; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #fc3935;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #f58f95; position: relative;}
	...
	@media all and (min-width: 360px) and (max-width: 768px) { /*모바일 */
		...
		#stardiv{width:320px; height: 1000px; border-radius: 15px; top:46px; }
		...
		#starimg{width: 150px; height: 96px; top:8px;}
		#snamediv{top:19px;}
	...
	@media all and (min-width: 768px) { /*태블릿 */
		...
		#stardiv{width:456px; height: 1353px; border-radius: 15px; top:46px;}
		...
		#starimg{width: 215px; height: 127px; top:30px;}
		#snamediv{top:35px;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . . 화끈하게 즐기는 중 . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">강렬한 햇빛이 내리쬐는 멕시코<br>
				카사코코</font>에 도착한 당신은 멕시코의<br>
				화끈한 열기가 마음에 드시나요?<br><br>
				멕시코의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">어떤 일이든 열정적이고 화끈하게<br>
				풀어내는 해결사</font>일 것 같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">강렬한 햇빛이 내리쬐는 멕시코 카사코코</label></div>
				...
				<img src = "image/점선_멕시코.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_멕시코.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_멕시코.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_멕시코.svg" id = "passimg">
			</div>
			
			<div id = "stardiv">
				<div id = "startitlediv"><label id = "startitle">당신의 수호별</label></div>
				<div id = "starnamediv"><label id = "starname">놀라운 균형을 가진 별,<br>트라피스트</label></div>
				<img src = "image/별자리_트라피스트.svg" id = "starimg">
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_멕시코.html'">
			</div>
