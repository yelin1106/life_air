...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #1e38af; position: relative; display: table; text-align: center;}
	...
	#boardingpassdiv{background-color: #1e38af; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #ffffff; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #1e38af;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #b6bee8; position: relative;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . . 빗물 샤워중 . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">꽤 많은 비가 내리는 인도 벽돌집</font><br>
				도착한 당신은 창 밖의 비를 보고<br>
				아련한 감상에 젖곤 해요. <br><br>
				인도의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">따뜻하고 감성적인 마음씨로 항상<br>
				주변을 잘 챙겨주는 좋은 사람</font>일 것 같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">쏟아지는 빗줄기의 시원함이 있는 인도 벽돌집</label></div>
				...
				<img src = "image/점선_인도.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_인도.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_인도.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_인도.svg" id = "passimg">
			</div>
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_인도.html'">
			</div>
