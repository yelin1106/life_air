...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #fdd60d; position: relative; display: table; text-align: center;}
	...
	#boardingpassdiv{background-color: #fdd60d; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #ffffff; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #fdd60d;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #fdd60d; position: relative;}
	...
	@media all and (min-width: 768px) { /*태블릿 */
		...
		#stardiv{width:456px; height: 1503px; border-radius: 15px; top:46px;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . . 꽃 향기에 취하는 중 . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">바람에 꽃 내음이 풍겨오는 네덜란드 풍차집</font>에<br>
				도착한 당신은 자연의 향기를 한껏<br>
				들이마시며 그 향기에 취하곤 해요.<br><br>
				네덜란드의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">향긋하고 시원한 성격으로 서로를 <br>
				잘 이끄는 사람</font>일 것 같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">바람에 꽃 내음이 풍겨오는 네덜란드 풍차집</label></div>
				...
				<img src = "image/점선_네덜란드.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_네덜란드.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_네덜란드.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_네덜란드.svg" id = "passimg">
			</div>
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_네덜란드.html'">
			</div>
