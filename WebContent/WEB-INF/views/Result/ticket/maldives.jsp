...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingpassdiv{background-color: #79e6d1; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #ffffff; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #79e6d1;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #b7ebe1; position: relative;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . . 흰 천과 바람만 있다면 . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">에메랄드 빛 바다 위 수상주택</font>에 도착한<br>
				당신은 로맨틱한 섯셋을 바라보며<br>
				근심걱정을 모두 잊고 편히 눈을 감아요.<br><br>
				몰디브의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">흰 천과 바람만 있다면 어디든 갈 수 있는<br>
				자유로운 영혼의 소유자</font>같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">에메랄드 빛 바다, 몰디브 수상주택</label></div>
				...
				<img src = "image/점선_몰디브.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_몰디브.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_몰디브.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_몰디브.svg" id = "passimg">
			</div>
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_몰디브.html'">
			</div>
