...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #f9466e; position: relative; display: table; text-align: center;}
	...
	#boardingpassdiv{background-color: #f9466e; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #ffffff; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #f9466e;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #ff9db3; position: relative;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . . 눈동자 속 오로라 . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">호빗들이 살았다는 잔디주택</font>에 짐을 내려두고<br>
				노곤노곤한 온천 스파클링을 즐기던 중에<br>
				오늘, 오로라가 보인다는 소식이 들려와요.<br><br>
				아이슬란드의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">서로의 눈에 비친 오로라를 보며<br>
				사랑을 맹세하는 낭만적인 사람</font> 같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">호빗들이 살았다는, 아이슬란드 잔디주택</label></div>
				...
				<img src = "image/점선_아이슬란드.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_아이슬란드.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_아이슬란드.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_아이슬란드.svg" id = "passimg">
			</div>
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_아이슬란드.html'">
			</div>
