...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #fffcf3; position: relative; display: table; text-align: center;}
	#boarding{display: table-cell; text-align: center; vertical-align: middle;font-family: "Roboto"; font-weight: 100; font-stretch: normal; font-style: normal; letter-spacing: normal; text-align: center; color: #474747; line-height: 1.42;}
	...
	#boardingpassdiv{background-color: #fffcf3; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #474747; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #fffcf3;}
	...
	#sig{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 1.43; letter-spacing: normal; color: #474747;}
	#sigkdiv{position: relative; display: table; text-align: center;}
	#sigk{font-family: 'Noto Sans CJK KR'; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.5; letter-spacing: -0.8; color: #474747;}
	...
	#tog{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 1.43; letter-spacing: normal; color: #474747;}
	#togkdiv{position: relative; display: table; text-align: center;}
	#togk{font-family: 'Noto Sans CJK KR'; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.5; letter-spacing: -0.8; color: #474747;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #474747; opacity: 0.5; position: relative;}
	...
	@media all and (min-width: 360px) and (max-width: 768px) { /*모바일 */
		...
		#stardiv{width:320px; height: 1050px; border-radius: 15px; top:46px; }
		...
		#starimg{width: 150px; height: 124px; top:8px;}
		#snamediv{top:19px;}
	...
	@media all and (min-width: 768px) { /*태블릿 */
		...
		#stardiv{width:456px; height: 1363px; border-radius: 15px; top:46px;}
		...
		#starimg{width: 215px; height: 137px; top:30px;}
		#snamediv{top:35px;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . . 눈 밭에서 구르는 중 . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">온 세상을 하얗게 덮은 눈, 알래스카 이글루</font>에<br>
				도착한 당신은 눈 밭에서 굴러도 보고<br>
				입에 한 가득 눈을 넣어보기도 해요.<br><br>
				알래스카의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">겉으로 보기엔 차갑지만 알고보면<br>
				따뜻하고 순수한 마음</font>을 가졌을 것 같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			<div id = "boardingpassdiv">
				...
				<img src = "image/보딩패스_가는길블랙.svg" id = "boardingplane">
				<div id = "fromdiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">온 세상을 하얗게 덮은 눈, 알래스카 이글루</label></div>
				...
				<img src = "image/점선_알래스카.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_알래스카.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_알래스카.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_알래스카.svg" id = "passimg">
			</div>
			
			<div id = "stardiv">
				<div id = "startitlediv"><label id = "startitle">당신의 수호별</label></div>
				<div id = "starnamediv"><label id = "starname">빛나는 자유로움을<br>가진 별, 베텔게우스</label></div>
				<img src = "image/별자리_베텔게우스.svg" id = "starimg">
				<div id = "snamediv"><label id = "sname">TRAPPIST-1</label></div>
				<div id = "starcontentdiv"><label id = "starcontent">
					<p>여행의 시작에 선 당신을 위해 작은 선물을 준비했어요.  트라피스트 행성계의 일곱 행성은 완벽한 조화를 이루며 공전해요. 상당히 가까운 공간 안에서 여러 행성이 일정한 패턴을 유지하며 공존하는 경이로운 모습은 당신을 떠올리게 해요.</p><br>
					<p>당신은 어지럽고 혼란한 틈 사이의 균형을 찾는 <font style = "font-weight: bold">듬직한 사람</font>이에요. 당신이 차곡차곡 만든 생활의 규칙을 보면, 어느 곳에서든 숨 쉴 수 있다는 걸 알게 돼요.</p><br>
					<p>당신의 정돈된 모습에 당신의 동반자는 큰 안정감을 느껴요. 당신과 함께 있으면 시끄러운 머릿속이 잠잠해지고 단정한 평화가 찾아오니까요. 당신과 함께라면 내일이 두렵지 않아요. </p><br>
					<p>당신에게 이 별을 드릴게요.</p><br>
					<p>트라피스트의 빛과 함께 앞으로의 여정이 평화롭기를 기원합니다.</p>
					</label>
				</div>
			</div>
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_알래스카.html'">
			</div>
