...
<style>
	* {margin: 0; padding: 0;}
	...
	#boardingdiv{background-color: #34b39e; position: relative; display: table; text-align: center;}
	...
	#boardingpassdiv{background-color: #34b39e; position: relative; display: table; text-align: center; box-shadow: 0 3px 6px 0 rgba(0, 0, 0, 0.16);}
	#boardingtitlediv{background-color: #ffffff; position: relative; display: table; text-align: center;}
	#boardingtitle{font-family: "Roboto"; font-weight: bold; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #34b39e;}
	...
	.alltitle{font-family: "Roboto"; font-weight: normal; font-stretch: normal; font-style: normal; line-height: 2.13; letter-spacing: normal; color: #8ce3d5; position: relative;}
...
<body>
	<div id = "main">
		...
		<div id = "titlediv">
			<label id = "title">. . .앞, 뒤 굴러도 인생샷 . . .</label>
		</div>
		
		<div id = "landingdiv">
			<label id = "landing">
				당신과 동반자는 드디어 착륙했어요.<br>
				<font class = "landing_highlight">잘 정돈된 정원을 가진 전원주택의 창밖</font><br>
				뭉게구름과 높은 하늘을 배경삼아<br>
				할 수 있는 가장 멋있는 포즈를 취해요.<br><br>
				호주의 날씨처럼 당신과 동반자는<br>
				<font class = "landing_highlight">변함없는 열정과 따스함을 가진<br>
				청명하고 생기 가득한 사람</font>같아요.<br>
				당신의 동반자들도 잘 도착했을까요?
			</label>
		</div>
		...
		<div id = "alldiv">
			...
			<div id = "destinationdiv">
				...
				<div id = "descondiv"><label class = "allcontent">잘 정돈된 정원을 가진 호주 전원주택</label></div>
				...
				<img src = "image/점선_호주.svg" class = "line">
			</div>
			...
			<div class = "passengerdiv">
				...
				<img src = "image/점선_호주.svg" class = "passline">
			</div>
			...
			<div id = "totalpassengerdiv">
				...
				<img src = "image/점선_호주.svg" id = "totalline">
			</div>
			...
			<div id = "passdiv">
				...
				<img src = "image/패스_호주.svg" id = "passimg">
			</div>
			...
			<div id = "showdiv">
				...
				<img src = "image/터치미.svg" id = "touchme" onClick="location.href = '뽐내기_호주.html'">
			</div>
